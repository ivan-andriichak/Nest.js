...
export class AddBaseEntities1718090467620 implements MigrationInterface {
    name = 'AddBaseEntities1718090467620'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "isPrimary" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "users" ADD "isBeneficiary" boolean NOT NULL DEFAULT false`);
