...
export class AddCommentEntities1718100715226 implements MigrationInterface {
    name = 'AddCommentEntities1718100715226'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "follow" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "follower_id" uuid NOT NULL, "following_id" character varying NOT NULL, "article_id" uuid, CONSTRAINT "PK_fda88bc28a84d2d6d06e19df6e5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "follow" ADD CONSTRAINT "FK_3e5b4f1242847e77b09d5606be0" FOREIGN KEY ("article_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "follow" DROP CONSTRAINT "FK_3e5b4f1242847e77b09d5606be0"`);
